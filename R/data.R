...
#'   \item{\code{honesty}}{character Reputations for the quality of being honest or not lying or intentionally deceiving others (as well as those dispossessing this trait – those who transmit non-truthful information, especially with an intent to deceive).}
...
#'   \item{\code{industriousness}}{character Reputations based on productive outputs from activities such as subsistence and other economic efforts, domestic work, recreational accomplishments, etc., including past and current productivity (includes individuals who dispossess this trait).}
...
#'   \item{\code{agressiveness}}{character Reputations for a propensity to act aggressively and agonistically, though which may not include control or influence (includes individuals who dispossess this trait).}
#'   \item{\code{social_status}}{character Reputations for having a high rank within social hierarchies, prestige, or esteem (or their opposite). Includes “global” social status, conceived broadly and likely dependent on multiple criteria. Separate from “coercive ability” reputations.}
#'   \item{\code{parental_care}}{character Reputations for being a good parent, successfully raising many/quality children, and/or investing a lot of time, resources, and energy in raising children. (includes individuals who dispossess this trait).}
#'   \item{\code{sociosexuality}}{character Reputations for having many sexual partners and/or willingness to engage in sexual activity or develop multiple sexual/romantic relationships (e.g., high sociosexuality) (includes individuals who dispossess this trait, e.g., low sociosexuality).}
#'   \item{\code{sexual_fidelity}}{character Reputations for fidelity, sexual exclusivity, and maintaining physical commitment within a marriage or sexual relationship (includes individuals who dispossess this trait).}
#'   \item{\code{somatic_capital}}{character Reputations for beneficial and positive physiological traits including health, strength, agility and dexterity (includes individuals who dispossess this trait).}
#'   \item{\code{neural_capital}}{character Reputations for cognitive and neural-based dimensions of somatic or embodied capital, including reputations for generalized or specialized intelligence, special knowledge, cognitive abilities, and decision-making capacities (includes individuals who dispossess this trait).}
#'   \item{\code{social_capital}}{character Reputations for having a large and/or strong social support network including having many social partners, kin or allies and having social partners, kin, or allies who are of high quality (includes individuals who dispossess this trait).}
#'   \item{\code{material_capital}}{character Reputations for having high levels of material wealth, including all forms of material wealth and currencies, such as money, territory, prestige goods, property, having food reserves, and other material resources (includes individuals who dispossess this trait).}
...
#'   \item{\code{teaching}}{character Reputations for being a good teacher including all forms of teaching, defined as an informed individual modifying their behaviour for the learning benefit of a naive individual. Includes capacities to train and transmit specialized or generalized information. (includes individuals who dispossess this trait).}
#'   \item{\code{oration}}{character Reputations for having (or not having) a superior ability to use language or other forms of vocalization in public and private contexts (includes individuals who dispossess this trait).}
#'   \item{\code{bravery}}{character Reputations for the ability or disposition to voluntarily act when facing personal risk (in terms of agony, pain, loss, danger, uncertainty, or intimidation) in pursuit of a worthy goal, often in the face of fear (includes individuals who dispossess this trait).}
